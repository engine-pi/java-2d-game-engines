 ...
 */
public final class StateCrouch extends StateHelper<EntityModel>
{
    ...
    public StateCrouch(EntityModel model, Animation animation)
    {
        ...
        addTransition(StateUncrouch.class, () -> !isGoDown() && animatable.getFrameAnim() == 2);
        addTransition(StateIdle.class, () -> !isGoDown() && animatable.getFrameAnim() == 1);
    }
