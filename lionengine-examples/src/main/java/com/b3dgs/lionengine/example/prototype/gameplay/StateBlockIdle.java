...
/**
 * State block idle implementation.
 */
public final class StateBlockIdle extends StateHelper<EntityModel>
{
    /**
     * Create the state.
     * 
     ...
     */
    public StateBlockIdle(EntityModel model, Animation animation)
    {
        super(model, animation);

        addTransition(StateLast.class, () -> !isFire(DeviceMapping.FIRE2));
