...
public interface hb_draw_cubic_to_func_tI extends CallbackI {
    ...
    Callback.Descriptor DESCRIPTOR = new Callback.Descriptor(
        hb_draw_cubic_to_func_tI.class,
    ...
    /** {@code void (* hb_draw_cubic_to_func_t) (hb_draw_funcs_t * dfuncs, void * draw_data, hb_draw_state_t * st, float control1_x, float control1_y, float control2_x, float control2_y, float to_x, float to_y, void * user_data)} */
