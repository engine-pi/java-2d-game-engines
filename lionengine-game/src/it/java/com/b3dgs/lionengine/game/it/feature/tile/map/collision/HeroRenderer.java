 ...
 */
@FeatureInterface
public final class HeroRenderer extends FeatureModel implements Displayable
{
     ...
     */
    public HeroRenderer(Services services, Setup setup, Collidable collidable, Transformable transformable)
    {
        ...
        text.setText(Hero.class.getSimpleName());
    ...
    public void render(Graphic g)
    {
        ...
        text.draw(g, transformable, 0, 28, Align.CENTER, Hero.class.getSimpleName());
        text.render(g);
