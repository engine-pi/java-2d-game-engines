 ...
 */
public final class Hero extends FeaturableModel
{
    /** Media reference. */
    public static final Media MEDIA = Medias.create("Hero.xml");
     ...
     */
    public Hero(Services services, Setup setup)
    {
        ...
        addFeature(HeroUpdater.class, services, setup);
        addFeature(HeroRenderer.class, services, setup);
    }
}
