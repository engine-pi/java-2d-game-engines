...
final class UtilLaunchable
{
    ...
    public static Media createLauncherMedia(Media launchableMedia, int delay)
    {
        ...
        final LaunchableConfig launchableConfig = new LaunchableConfig(launchableMedia.getPath(),
                                                                       ...
                                                                       2,
                                                                       new Force(1.0, 2.0));
        final LauncherConfig launcherConfig = new LauncherConfig(0, 10, false, false, Arrays.asList(launchableConfig));

        final Xml root = new Xml("test");
        root.add(LauncherConfig.exports(launcherConfig));
        root.add(LauncherConfig.exports(new LauncherConfig(1, 50, false, false, Arrays.asList(launchableConfig))));
        root.save(media);
